...
int main(int argc, char** argv) {
  ...
  noiseModel::Diagonal::shared_ptr priorModel = noiseModel::Diagonal::Sigmas(Vector3(1.0, 1.0, 0.1));// 就是第3维的数据值,相对较准
  graph.add(PriorFactor<Pose2>(Symbol('x', 1), Pose2(0, 0, 0), priorModel));//Pose2(0, 0, 0)代表起始的原点,整个轨迹定在整个世界坐标系中起始点的位置
